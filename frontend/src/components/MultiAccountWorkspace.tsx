...
import type { MultipleAccount } from "@/components/SearchBar";
            ...
            <div className="flex items-center gap-2 self-start">
              ...
              <span
                className={cn(
                  ...
                  isFetchingAll || stats.fetching > 0
                    ? "border-blue-500/20 bg-blue-500/10 text-blue-300"
                    : "border-emerald-500/20 bg-emerald-500/10 text-emerald-300"
                )}
              >
                <Clock3 className="h-3.5 w-3.5" />
                {isFetchingAll || stats.fetching > 0 ? "Queue Running" : "Queue Complete"}
              </span>
            </div>

            <div className="w-full lg:min-w-[320px] lg:max-w-[360px]">
              <Button
